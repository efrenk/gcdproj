run_analysis
============
Last updated 2014-07-26 19:26:18 using R version 3.1.1 (2014-07-10).
...
```
## [1] "/Users/efrenk/my-data-clean/GCDProject"
```
...
Download the file. Put it in the `data` folder. **This was already done before**
...
**See the `README.txt` file in /Users/efrenk/my-data-clean/GCDProject for detailed information on the dataset.**
